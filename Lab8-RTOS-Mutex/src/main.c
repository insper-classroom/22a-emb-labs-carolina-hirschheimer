...
void lv_termostato(void) {
	...
	lv_obj_align_to(btnClock, btnMenu, LV_ALIGN_OUT_RIGHT_MID, 0, -10);
	...
	lv_obj_align_to(upBtn, downBut ,LV_ALIGN_OUT_LEFT_MID, -30, -10);
	...
	lv_obj_align(labelTime, LV_ALIGN_TOP_RIGHT, -20 , 10);
